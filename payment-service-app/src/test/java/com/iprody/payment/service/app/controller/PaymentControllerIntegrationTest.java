...
class PaymentControllerIntegrationTest extends
    ...
    void shouldReturnOnlyLiquibasePayments() throws Exception {
        mockMvc.perform(get("/payments")
                        ...
                        .with(
                                TestJwtFactory.jwtWithRole("test-user",
                ...
                .andExpect(jsonPath("$.content[?(@.guid=='00000000-0000-0000-0000-000000 000001')]").exists())
                .andExpect(jsonPath("$.content[?(@.guid=='00000000-0000-0000-0000-000000 000002')]").exists())
                .andExpect(jsonPath("$.content[?(@.guid=='00000000-0000-0000-0000-000000 000003')]").exists());
    }
    @Test
    void shouldCreatePaymentAndVerifyInDatabase() throws Exception {
        ...
        Optional<Payment> saved =
                paymentRepository.findById(created.getId());
